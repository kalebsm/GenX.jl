...
|$\Omega^{elec}_{y,z} \in \mathbb{R}_+$ | Installed electrolyzer capacity of resource $y$  in zone $z$ - only applicable for co-located VRE and storage resources with an electrolyzer component, $y \in \mathcal{VS}^{elec}$ \[MW DC\]|
...
|$\Delta^{elec}_{y,z} \in \mathbb{R}_+$ | Retired electrolyzer capacity of technology $y$ from existing capacity in zone $z$ - only applicable for co-located VRE and storage resources with an electrolyzer component, $y \in \mathcal{VS}^{elec}$ \[MW DC\]|
...
|$\Delta_{y,z}^{total,elec} \in \mathbb{R}_+$ | Total installed electrolyzer capacity of technology $y$ in zone $z$  - only applicable for co-located VRE and storage resources with an electrolyzer component, $y \in \mathcal{VS}^{elec}$ \[MW DC\]|
...
|$\overline{\Omega}^{elec}_{y,z}$ | Maximum electrolyzer capacity of technology $y$ in zone $z$ - only applicable for co-located VRE and storage resources with an electrolzyer component, $y \in \mathcal{VS}^{elec}$ \[MW DC\]|
|$\underline{\Omega}^{elec}_{y,z}$ | Minimum electrolyzer capacity of technology $y$ in zone $z$ - only applicable for co-located VRE and storage resources with an electrolyzer component, $y \in \mathcal{VS}^{elec}$ \[MW DC\]|
...
|$\overline{\Delta^{elec}_{y,z}}$ | Existing installed electrolyzer capacity of technology $y$ in zone $z$ - only applicable for co-located VRE and storage resources with an electrolyzer component, $y \in \mathcal{VS}^{elec}$ \[MW DC\]|
...
|$\pi_{y,z}^{INVEST,elec}$ | Investment cost (annual amortization of total construction cost) for electrolyzer capacity of technology $y$ in zone $z$ - only applicable for co-located VRE and storage resources with an electrolyzer component, $y \in \mathcal{VS}^{elec}$ \[\$/MW DC-yr\]|
...
|$\pi_{y,z}^{FOM,elec}$ | Fixed O&M cost of the electrolyzer component of technology $y$ in zone $z$ - only applicable for co-located VRE and storage resources with an electrolyzer component, $y \in \mathcal{VS}^{elec}$ [\$/MW DC-yr]|
